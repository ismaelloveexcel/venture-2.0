...
def api_call(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        retried = with_retry(max_attempts=max_attempts, initial_wait=initial_wait)(rate_limited)
        return retried
...
hunter_api_call = lambda func: api_call(max_per_second=0.5, max_attempts=3, initial_wait=2.0)(func)

# Notion: 3 req/sec, but backoff aggressively on 429
notion_api_call = lambda func: api_call(max_per_second=2.0, max_attempts=5, initial_wait=1.0)(func)

# Brave Search: 15 req/sec — generous
brave_api_call = lambda func: api_call(max_per_second=10.0, max_attempts=3)(func)
